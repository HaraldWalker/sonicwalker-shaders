...
Concentric arc bands inspired by the modular grid experiments in Karl Gerstner's Brockmann-era pattern studies. Each band is independently rotated, swept, and quantized to a polar grid, with a slow spin and ease curve shaping how the rings fan outward.
